...
type FeedRequest struct {
	...
	Uid int64 `protobuf:"varint,1,opt,name=uid,proto3" json:"uid,omitempty"` // user id
}
...
type FeedResponse struct {
	...
	Cids []int64 `protobuf:"varint,1,rep,packed,name=cids,proto3" json:"cids,omitempty"` // container id list
}
...
func (x *FeedResponse) GetCids() []int64 {
	if x != nil {
		return x.Cids
	}
	return nil
...
var file_feed_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x66, 0x65, 0x65, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1f, 0x0a, 0x0b,
